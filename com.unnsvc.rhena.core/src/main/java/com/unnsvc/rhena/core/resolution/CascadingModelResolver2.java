...
public class CascadingModelResolver2 {
	...
	public CascadingModelResolver2() {

		this.mergedModules = new HashMap<ModuleIdentifier, RhenaMergedModule>();
	}

	public CascadingModelResolver2(IRhenaConfiguration config, IRhenaResolver resolver, IRhenaCache cache) {
