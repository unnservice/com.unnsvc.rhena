...
//	public void fireLogEvent(ELogLevel level, Class<?> clazz, ModuleIdentifier identifier, String message, Throwable throwable) throws RemoteException;
	...
	public void fireLogEvent(ELogLevel level, String loggerName, ModuleIdentifier identifier, String message, RemoteException exception) throws RemoteException;
}
